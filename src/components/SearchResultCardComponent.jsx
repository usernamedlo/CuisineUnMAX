...
function SearchResultCardComponent({ recipe }) {
  ...
  return (
    ...
    >
      ...
      <div
        className="h-12 w-12 m-2 rounded-full border-4 border-red-500 bg-red-500 flex justify-center items-center"
        style={{
          transform: showCircles ? "translateX(10%)" : "translateX(-80%)",
          transition: "transform 0.4s ease",
        }}
      >
      ...
      <div
        className="h-12 w-12 m-2 rounded-full border-4 border-blue-900 bg-blue-500 flex justify-center items-center"
        style={{
          transform: showCircles ? "translateX(10%)" : "translateX(-80%)",
          transition: "transform 0.4s ease",
        }}
